...
Factor augmented VAR is originally credited to Bernanke, Boivin and Eliasz (2005). Unlike the structural VAR models which addresses only unanticipated changes to monetary policy, FAVAR also captures anticipated changes to monetary policy. 
