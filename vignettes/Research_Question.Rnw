...
The objective for this project is to examine forward guidance by the U.S. Federal Reserve Bank and how public statements can affect market expectations. Specifically: do statements released by the Federal Open Market Committee contain information that the market might not have learned otherwise?

\section{Motivation}

During eight year period between December 16, 2008 and December 14, 2016, the U.S. Federal Reserve maintained a constant federal funds target rate of 0 to 0.25\%. With policy makers effectively unable to lower rates further, public statements became a primary tool for affecting market expectations and outcomes.
